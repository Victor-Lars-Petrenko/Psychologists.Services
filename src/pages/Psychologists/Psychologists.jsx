...
} from "../../redux/psychologists/psychologists-selectors";
import { useEffect } from "react";
import { loadPsychologists } from "../../redux/psychologists/psychologists-operations";

const Psychologists = () => {
  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(loadPsychologists());
  }, [dispatch]);

  const cards = useSelector(selectPsychologists);
  const isLoading = useSelector(selectPsychologistsLoading);
  console.log(cards);
